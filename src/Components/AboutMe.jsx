...
const SocialIcon = ({ icon, username, link }) => {
...
export default function AboutMe() {
  ...
  const tooltipStyles = theme === "dark" ? "bg-white text-black" : "bg-slate-900 text-white";
  const iconAccent = theme === "dark" ? "text-gray-400" : "text-slate-500";
  const componentLinkStyles =
    theme === "dark"
    ...
    <section className={`relative w-full max-w-4xl mx-auto overflow-hidden ${theme === "dark" ? "" : "text-slate-800"}`}>
      <div className="flex flex-col md:flex-row items-center md:items-start">
        ...
        <div className="md:w-1/4 p-6 pr-4 pb-3 flex flex-col items-center md:items-start gap-4 relative">
          <div className="w-40 h-40 rounded-lg overflow-hidden relative">
            <img src="https://static.vecteezy.com/system/resources/previews/066/640/473/non_2x/boy-developer-or-software-engineer-mascot-cartoon-character-template-vector.jpg" alt="Uzair" className="w-full h-full object-cover" />
          </div>
        </div>
        ...
        <div className="relative md:w-2/3 pt-4 md:pl-2 flex flex-col items-center md:items-start justify-center text-center md:text-left">
          ...
          <div className="flex w-full flex-col gap-2 items-center md:flex-row md:items-center md:gap-3 mb-3">
            <h1 className={`text-2xl font-bold ${headingColor}`}>Uzair Baluch ⚡</h1>
          </div>

          <p className={`text-lg ${roleColor}`}>Frontend Developer</p>

          {/* Social Icons */}
          <div className="flex flex-wrap gap-3 my-3">
            <SocialIcon icon={<SiLeetcode />} username="uzairbaluch" link="https://leetcode.com/u/uzairbaluch/" />
           
            <SocialIcon icon={<SiGithub />} username="UzairBaluch" link="https://github.com/UzairBaluch" />
            <SocialIcon icon={<SiBuymeacoffee />} username="BuyMeACoffee" link="#" />
          </div>
          ...
          <div className="flex flex-wrap gap-5 pl-[2px]">
            ...
            <div className="relative">
              <a
                href="mailto:uzairbaluchdev@gmail.com"
      ...
      >
        <div className="relative flex flex-col gap-0.5">
          ...
          <span className="text-[11px] font-normal opacity-80">click for micro-interactions</span>
          {showComponentTip && (
            <motion.div
