    ...
    return (
        <main className={`min-h-screen ${mainStyles} max-w-3xl mx-auto`}>
            <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 py-10">
                <Link
                    to="/"
                    className={`ml-4 inline-flex items-center gap-2 self-start rounded-lg border border-dashed px-3 py-2 text-xs font-semibold transition ${linkStyles} ${depthEffect}`}
                >
